#Run pyscenic_grn.sh and then pyscenic_ctx.sh to generate necessary files
#Analysis the files with SCENIC_regulon.py

#Large files involved in the scripts were downloaded from these urls.
